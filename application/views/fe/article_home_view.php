...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-lg-3 lastest-post-container">
        ...
        <a href="<?=site_url("fe/article/getArticleDetail/".$row['articleID'])?>"><h4><?= $row['title'] ?></h4></a>
        <?= $row['created']?> 
    </div>
    <?php
        }
...
?>
    ...
    <div class="row">
        ...
        <?php $i=0; foreach($data['listArticle'] as $article){ ?>
            <?php if($i==0) { ?>
                <a href="<?=site_url('fe/article/getArticleDetail/'.$article['articleID'])?>">
