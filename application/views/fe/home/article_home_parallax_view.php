...
<div class="container-wrap-mid">
  ...
  <div class="wrap-mini-coba">
      ...
      <h4 style="text-align:center;"><a href="<?=site_url('fe/article/lastArticleList')?>"><b>Popular</b></a></h4>
  </div>
  <div class="clearfix"></div>

  <?php foreach ($category_data as $row){ ?>
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 centered hvr-bounce-in">
