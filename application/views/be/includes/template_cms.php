...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= site_url("be/dashboard/index") ?>">CMS Panel</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?= site_url('be/login/doLogout')?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <!--li class="sidebar-search"-->
                        ...
                        ?>
                        <li>
                            <a href="<?= site_url("be/user/userListCms")?>"><i class="fa fa-files-o fa-fw"></i> Manage Admins</a>                        
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Manage Appointments<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?= site_url("be/appointment/appointmentListCms") ?>">Appointments</a>
                                </li>
                            </ul>
                        </li>
                        <?php 
                        ...
                        ?>
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Manage Article<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?= site_url("be/article/getArticleListCms") ?>">Articles</a>
                                </li>
                                <li>
                                    <a href="<?= site_url("be/article/getCategoryArticleListCms") ?>">Category</a>
                                </li>
                                <li>
                                    <a href="<?= site_url("be/tag/getTagListCms") ?>">Tags</a>
                                </li>
                            </ul>
                        </li>
                        <?php
                        ...
                        <!--
                        <li>
                            <a href="#"><i class="fa fa-files-o fa-fw"></i> Manage Portofolio<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?= site_url("be/portofolio/getPortofolioListCms") ?>">Portofolio</a>
                                </li>
                            </ul>
                        </li> -->
                        <?php
